...
<div class="el-table-self"> 
    <el-table
        ...
        style="width: 100%"> <el-table-column v-if="checkBox" type="selection" width="55"> </el-table-column> <el-table-column
          ...
          :class-name="column.className"> </el-table-column> </el-table> <div class="pagination-footer"> <span class="description">{{description}}</span> <el-pagination
